...
const FilterPanel: React.FC<FilterPanelProps> = ({ onApplyFilter, isLoading, customPrompt, onCustomPromptChange }) => {
  ...
  return (
    <div className="w-full bg-gray-800/50 border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fade-in backdrop-blur-sm">
      ...
      <input
        ...
        placeholder="Ou descreva um filtro (ex: 'brilho synthwave anos 80')"
